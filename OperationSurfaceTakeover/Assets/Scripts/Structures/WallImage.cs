...
public class WallImage : MonoBehaviour
{
    ...
    WallButton structureButtonScript; //reference to the button that will spawn this object for walls
    ...
    public void Initialize(WallButton structureButton)
    {
    ...
    private void PlaceStructure(Dictionary<System.Enum, object> data)
    {
        ...
        theStructure.GetComponent<Wall>().Initialize(structureButtonScript, tile); //runs the initialize method of the turret
    }
